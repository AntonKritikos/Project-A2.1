...
if(isset($_FILES['image']))
{
	...
	if(move_uploaded_file($file, $destination))
	{
		...
		{
			//Executing the query
			$sql = ("UPDATE innovations SET title = '$title', title_color = '$title_color, subtitle = '$subtitle', subtitle_color = '$subtitle_color', content = '$content', background_color = '$background_color', button_text = '$button_text', button_link = '$button_link', button_align = 'button_align', background_image = '$destination");
...
{
	//Executing the query
	$result = $mysqli->query("UPDATE innovations SET title = '$title', title_color = '$title_color, subtitle = '$subtitle', subtitle_color = '$subtitle_color', content = '$content', background_color = '$background_color', button_text = '$button_text', button_link = '$button_link', button_align = 'button_align'");
	?>
	<div class="succes">

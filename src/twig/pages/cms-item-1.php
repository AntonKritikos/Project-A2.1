<div class="container--admin">
	<h1>CMS ITEMS</h1>
	<form action="dist/assets/php/send_content.php" method="post" enctype="multipart/form-data">
		...
		<input type="text" name="background_color" placeholder="Red">
		<a href="">Verwijder</a>
		<label for="button">Verander button</label>
		<input type="text" name="button_text" placeholder="Inschrijven">
		<input type="text" name="button_link" placeholder="Url:">
		<input type="text" name="button_align" placeholder="Links">
		<a href="">Contentblok verwijderen</a>
		<label for="button">
